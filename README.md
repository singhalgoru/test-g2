...
| | URL |
|---|---|
| Preview | https://main--test-g2--singhalgoru.aem.page/ |
| Live    | https://main--test-g2--singhalgoru.aem.live/ |
...
- [ ] AEM Sites console → Create → Site from template
  - Title: **Test G2** · Name: **test-g2** · GitHub: https://github.com/singhalgoru/test-g2
- [ ] Open Universal Editor → verify authoring → Quick Publish all pages
- [ ] Verify https://main--test-g2--singhalgoru.aem.page
